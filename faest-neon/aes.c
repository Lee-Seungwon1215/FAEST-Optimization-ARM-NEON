...
#if defined(HAVE_ARM64_NEON)
  switch (seclvl) {
  case 256:
    prg_neon_256(key, iv, tweak, out, outlen);
    return;
  case 192:
    prg_neon_192(key, iv, tweak, out, outlen);
    return;
  default:
    prg_neon_128(key, iv, tweak, out, outlen);
    return;
  }
#endif
...
// use AES-NI if possible
  ...
  switch (seclvl) {
  case 256:
    prg_2_lambda_neon_256(key, iv, tweak, out);
    return;
  case 192:
    prg_2_lambda_neon_192(key, iv, tweak, out);
    return;
  default:
    prg_2_lambda_neon_128(key, iv, tweak, out);
    return;
  }
#endif
...
// use AES-NI if possible
  ...
  switch (seclvl) {
  case 256:
    prg_4_lambda_neon_256(key, iv, tweak, out);
    return;
  case 192:
    prg_4_lambda_neon_192(key, iv, tweak, out);
    return;
  default:
    prg_4_lambda_neon_128(key, iv, tweak, out);
    return;
  }
#endif
